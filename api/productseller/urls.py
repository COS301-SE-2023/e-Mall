...
from .views import (
    ProductSellerFrontendAPIView,
    ProductSellerBackendAPIView,
    ProductSellerProdUpdateAPIView,
    ProductSellerProdDeleteAPIView,
    ProductSellerDashboardAPIView,
)
...
urlpatterns = [
    ...
    path(
        "sellerdashboard/",
        ProductSellerDashboardAPIView.as_view(),
